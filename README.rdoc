...
You can log in through the REST API with your username and password:

  session = client.login('username', 'password')

The session is returned as a hash, in the following format:

  {"session" => "cookie"}

To edit Open Library after logging in, you need to be a member of the {API Usergroup}[http://openlibrary.org/usergroup/api]. Send a message to the {ol-tech mailing list}[http://mail.archive.org/cgi-bin/mailman/listinfo/ol-tech] list for more information about how to join the group!
